				...
				<div class="">
					...
					>
						...
						>
							...
							<div class="composer-options mt-0.5 mb-2 mx-0.5 max-w-full" dir="ltr">
								<div class="composer-extensions ml-1 self-end flex items-center min-w-0">
									<InputMenu
										bind:files
								...
								<div
									class="composer-actions self-end flex space-x-1 mr-1 shrink-0 gap-[0.03125rem]"
								>
									{#if hasChatVariables}
...
<style>
	...
	@container chat-composer (min-width: 480px) {
		.composer-options {
			/* Keep the fixed menus and at least 2.5rem of extension options visible. */
			grid-template-columns: minmax(7.25rem, 1fr) minmax(0, max-content) auto;
			grid-template-areas: 'extensions models actions';
			row-gap: 0;
		}
